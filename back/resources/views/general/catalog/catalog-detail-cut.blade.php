...
<div class="content">
    ...
    <div class="catalog-main catalog-main-roll section-small-margin">
            ...
            <div class="catalog-info-head">
                ...
                <div class="roll-width">
                    ...
                    <div class="radio-list">
                        ...
                        <div class="radio-list-itm">
                            <input checked name="roll-width" type="radio" value="2.0">
                            <a class="radio-list-itm__name" href="">2,0 м</a>
                        </div>

                        <div class="radio-list-itm">
                            <input name="roll-width" type="radio" value="2.5">
                ...
                <div class="price-block">
                    <div class="price-block-head">
                        ...
                        <div class="price-type">
                            ...
                            <div class="price-type-val" data-type="m">пог. метр</div>

                            <img alt="" class="price-type__label" src="./img/ico/cut.svg">
                        </div>
                    </div>
                    <div class="price-block-val">
                        ...
                        <div class="price-block-val__itm" data-type="m">
        ...
        возможные варианты
            ...
            stock-3
            -->
                    <div class="product-stock__line stock-2">
                ...
                <div class="roll-calc-wrap">
                    <div class="roll-calc roll-calc--v3">
                        <div class="roll-calc__left">
                            <div class="roll-calc-img js-calc-img-cut">
                                <img alt="" class="svg" src="./img/ico/roll.svg">
                                <div class="roll-calc-img-move-wrap">
                                    <div class="roll-calc-img-move">
                                        <img alt="" class="svg" src="./img/ico/roll-line.svg">
                                        <div class="roll-calc-img-move__text">
                                            <span class="js-roll-width">2,0</span> м
                                        </div>
                                    </div>

                                    <div class="roll-calc__length"><span class="js-catalog-m-total">7,2</span> м</div>
                                </div>
                            </div>
                            <div class="roll-calc-img js-calc-img-full hide">
                                <img alt="" class="svg" src="./img/ico/roll-finished.svg">
                                <div class="roll-calc-img__right-text">
                                    <span class="js-roll-width">2,0</span> м
                                </div>
                            </div>
                            <div class="roll-calc__square">Площадь = <span class="js-catalog-m2-total-cut">1</span> м<sup>2</sup></div>
                        </div>

                        <div class="roll-calc__left js-buy-roll-col">
                            ...
                            <div class="roll-calc__square">Площадь = <span class="js-catalog-m2-total-roll">200</span> м<sup>2</sup></div>
                        </div>

                        <div class="roll-calc__right">
                            <div class="roll-calc__right__top">
                                <div class="roll-calc__cut">цена на отрез — 986₽/ м<sup>2</sup></div>
                                <div class="roll-calc__cut">цена за рулон — 956₽/ м<sup>2</sup></div>
                            </div>
