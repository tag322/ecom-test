    ...
    <div class="catalog-main section-small-margin">
        ...
        <div class="catalog-info">
            <div class="catalog-info-head">
                <div class="catalog-info__sku">Артикул: 3091</div>
                <h1 class="catalog-info__title">Кварцвиниловая ПВХ плитка (LVT) Forbo EFFEKTA STANDART Classic Granite</h1>
        ...
        возможные варианты
            ...
            stock-3
            -->
                    <div class="product-stock__line stock-3">
                        <span></span> <span></span> <span></span>
                    </div>
                </div>

                <div class="product-count-desc">сейчас на складе 111 уп.</div>
